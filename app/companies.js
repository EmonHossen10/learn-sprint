      ...
      <div className="my-5">
        <div className="mb-3 pt-10">
          <h1 className="text-4xl text-white text-center font-bold">
            Popular companies that are <br /> collaborating with us.
          </h1>
        </div>
        <hr className="border-[#54ef92] border-2 mb-5 max-w-[250px] mx-auto rounded-lg" />
        <div className="bg-[#121220] w-full h-[200px] flex flex-col justify-center">
          <div className="">
            <Marquee>
              ...
              <div className="mr-40">
                <Image src={layerWhite} alt="layer-White-logo" />
              </div>
              <div className="mr-40">
                <Image src={mailchimp} alt="mailchimp-logo" />
              </div>
              <div className="mr-40">
                <Image src={vidados} alt="vidados-logo" />
              </div>
            </Marquee>
          </div>
        </div>
        <div className="pb-10 mt-5 text-center">
          <h1 className="  font-medium text-sm pb-10">
            For further queries, please reach out to us at{" "}
            <span className="underline text-red-600">xyz@gmail.com</span>
          </h1>
        </div>
      </div>
    </div>
